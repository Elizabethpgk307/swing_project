...
public void run() {
try {
scientific_calc window = new scientific_calc();
...
frame.setBounds(100, 100, 558, 414);
...
textField.setBounds(10,32,245,36);
}
});
...
textField.setBounds(10,32,509,36);
...
lblCurrencyConverter.setFont(new Font("Iskoola Pota", Font.BOLD, 17));
